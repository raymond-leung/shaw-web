...
import { childrensLogin } from './../../actions/childrensAuthActions';
...
export class ChildrensLogin extends React.Component {
    constructor(props) {
        super(props);

        if(props.auth.childrensAuthenticated) {
            this.props.history.push('/childrens/rsvp');
        }
...
const mapStateToProps = (state) => {
    return {
        auth: state.auth,
        authForm: state.forms.childrensAuth,
    };
};

const mapDispatchToProps = (dispatch) => {
    return {
        login: (employeeId, employeeLastName) => { return dispatch(childrensLogin(employeeId, employeeLastName)) }
    };
};

export default withRouter(connect(mapStateToProps, mapDispatchToProps)(withStyles(styles)(ChildrensLogin)));
